...
<c:set var="mail" vlaue="${row.mail}"/>
<c:set var="mail1" vlaue="${mail.split('@')[0]}"/>
<c:set var="mail2" vlaue="${mail.split('@')[1]}"/>

<c:set var="birth" vlaue="${row.birth}"/>
<c:set var="year" vlaue="${row.split('/')[0]}"/>
<c:set var="month" vlaue="${row.split('/')[1]}"/>
<c:set var="day" vlaue="${row.split('/')[2]}"/>
